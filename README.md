...
2.  [**Filter Iterator**](./task-2-filter-iterator): Механизм ленивого прохода по элементам контейнеров (filter iterator), работающий с любыми `ForwardIterator`.
...
5.  [**Cryptography**](./task-5-cryptography-and-strategy-pattern): Набор алгоритмов шифрования (TEA, XOR) и режимов работы (CBC, ECB) для шифрования данных.
